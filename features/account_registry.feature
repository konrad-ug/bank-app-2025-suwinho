Feature: Account registry
  ...
  Scenario: User is able to update name of already created account
    ...
    When I update "name" of account with pesel: "89092909246" to "courtney"
    Then Account with pesel "89092909246" has "name" equal to "courtney"

  Scenario: Created account has all fields correctly set
    Given Account registry is empty
    When I create an account using name: "parov", last name: "stelar", pesel: "81092909876"
    Then Account with pesel "81092909876" has "name" equal to "parov"
    And Account with pesel "81092909876" has "surname" equal to "stelar"
    And Account with pesel "81092909876" has "balance" equal to "0.0"
